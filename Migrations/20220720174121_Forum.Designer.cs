...
namespace Intro.Migrations
{
    ...
    [Migration("20220720174121_Forum")]
    partial class Forum
    {
            ...
            modelBuilder.Entity("Intro.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("826ee5ab-e889-4743-9be6-51a681c40dd4"),
                            Avatar = "",
                            Login = "Admin",
                            PassHash = "",
                            PassSalt = "",
                            RealName = "Корневой администратор",
                            RegMoment = new DateTime(2022, 7, 20, 20, 41, 21, 256, DateTimeKind.Local).AddTicks(4684)
                        });
                });
